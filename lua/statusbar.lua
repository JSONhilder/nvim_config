...
gls.left[1] = {
    ViMode = {
        provider = function()
            ...
            local mode_color = {
                n = colors.gruv_orange,
                i = colors.gruv_yellow,
                v = colors.gruv_purple,
                V = colors.gruv_purple,
                c = colors.magenta,
                no = colors.blue,
                s = colors.orange,
...
gls.left[5] = {
    DiffAdd = {
        ...
        condition = condition.hide_in_width,
        icon = "  ",
        highlight = {colors.gruv_green, colors.bg}
    }
}
gls.left[6] = {
    DiffRemove = {
...
gls.right[9] = {
    BufferType = {
        ...
        separator = " ",
        separator_highlight = {"NONE", colors.bg},
        highlight = {colors.gruv_orange, colors.bg}
    }
}
...
gls.right[10] = {
    FileEncode = {
        ...
        separator = " ",
        separator_highlight = {"NONE", colors.bg},
        highlight = {colors.gruv_aqua, colors.bg}
    }
}
